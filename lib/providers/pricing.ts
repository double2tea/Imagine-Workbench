...
const RUNNINGHUB_PRICES: ProviderPriceEntry[] = [
  ...
  // --- Gemini Pro Official ---
  { pathMatch: "rhart-image-n-pro-official/text-to-image", price: 0.38, unit: "张" },
  { pathMatch: "rhart-image-n-pro-official/edit", price: 0.44, unit: "张" },
  { pathMatch: "rhart-image-n-pro-official/text-to-image-ultra", price: 0.38, unit: "张" },
  { pathMatch: "rhart-image-n-pro-official/edit-ultra", price: 0.44, unit: "张" },
  ...
  { pathMatch: "rhart-video-v3.1-fast-official/text-to-video", price: 4.03, unit: "次" },
  { pathMatch: "rhart-video-v3.1-fast-official/image-to-video", price: 4.03, unit: "次" },
  { pathMatch: "rhart-video-v3.1-fast/reference-to-video", price: 4.03, unit: "次" },
  { pathMatch: "rhart-video-v3.1-fast/text-to-video", price: 4.03, unit: "次" },
  { pathMatch: "rhart-video-v3.1-fast/image-to-video", price: 4.03, unit: "次" },
  ...
  { pathMatch: "rhart-video-v3.1-pro-official/reference-to-video", price: 1.89, unit: "次" },
  { pathMatch: "rhart-video-v3.1-pro-official/text-to-video", price: 1.89, unit: "次" },
  { pathMatch: "rhart-video-v3.1-pro-official/image-to-video", price: 1.89, unit: "次" },
  { pathMatch: "rhart-video-v3.1-pro/reference-to-video", price: 1.89, unit: "次" },
  { pathMatch: "rhart-video-v3.1-pro/text-to-video", price: 1.89, unit: "次" },
  { pathMatch: "rhart-video-v3.1-pro/image-to-video", price: 1.89, unit: "次" },
];
