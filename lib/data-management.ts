...
import {
  ...
  isUiPreferenceKey,
  readManagedLocalStorageEntries,
  type LocalStorageCleanupKind,
  type LocalStorageInventoryEntry,
...
import {
  ...
  type WorkspaceSafetySnapshotSummary,
} from "@/lib/workspace-backup-format";

export type { WorkspaceSafetySnapshotReason };
export type { WorkspaceExportResult, WorkspaceSafetySnapshotSummary } from "@/lib/workspace-backup-format";

export { WORKSPACE_BACKUP_SCHEMA_VERSION };
...
export type {
  ...
  LocalStorageInventoryEntry,
  LocalStorageMigrationPolicy,
  WorkspaceCleanupKind,
} from "@/lib/workspace-local-storage-inventory";
export { buildManagedLocalStorageInventory } from "@/lib/workspace-local-storage-inventory";
