export const TEAM_MEDIA_MAINTENANCE_TARGETS = ["maintenance-files", "missing-payload-assets"] as const;
...
export function isTeamMediaMaintenanceTarget(value: unknown): value is TeamMediaMaintenanceTarget {
  return value === "maintenance-files" || value === "missing-payload-assets";
}
