...
export interface LocalStorageEnvironment {
  ...
  IMAGINE_POSTGRES_CONNECTION_TIMEOUT_MS?: string;
  IMAGINE_POSTGRES_IDLE_TIMEOUT_MS?: string;
  IMAGINE_POSTGRES_POOL_MAX?: string;
  IMAGINE_POSTGRES_QUERY_TIMEOUT_MS?: string;
