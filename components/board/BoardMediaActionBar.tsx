...
export default function BoardMediaActionBar({ groups, visible = false }: BoardMediaActionBarProps) {
  ...
  return (
    <div
      className={`board-media-controls board-media-top-actions nodrag nopan absolute bottom-full right-0 z-40 mb-12 flex w-max max-w-none flex-nowrap items-center justify-end gap-1.5 whitespace-nowrap transition-opacity duration-200 ${visibilityClass}`}
