import { Clock3, ImageDown, ImageIcon, type LucideIcon, SkipBack, SkipForward, VideoIcon } from "lucide-react";
...
export default function AssetBoardNode({ node, onCaptureVideoFrame }: AssetBoardNodeProps) {
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      <div className="group/board-video flex min-h-0 flex-1 items-center justify-center overflow-hidden bg-[var(--iw-panel-soft)]">
