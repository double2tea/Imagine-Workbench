...
const AssetBoardNode = memo(function AssetBoardNode({
  ...
  return (
    <div className="board-media-node group/board-video relative h-full min-h-0 overflow-visible">
      ...
      <div
        className="pointer-events-none absolute bottom-2 left-2 z-30 max-w-[calc(100%-1rem)] rounded-md bg-slate-950/60 px-2 py-1 text-[10px] font-semibold text-white/90 opacity-0 shadow-lg backdrop-blur transition-opacity duration-200 group-hover/board-video:opacity-100"
