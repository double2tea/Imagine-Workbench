  ...
  return (
    <header className="imagine-board-header">
      <div className="imagine-board-header-zone imagine-board-header-zone--document">
        ...
        <div ref={boardMenuRef} className="relative min-w-0">
          <button
          ...
          {isBoardMenuOpen ? (
            <div
              className="imagine-board-header-menu fixed z-50 w-[20rem] max-w-[calc(100vw-1.5rem)]"
      ...
      <div className="imagine-board-header-zone imagine-board-header-zone--create">
        <div ref={insertMenuRef} className="relative flex min-w-0 items-center">
          ...
          {isInsertMenuOpen ? (
            <div
              className="imagine-board-header-menu fixed z-50 w-44 p-1.5"
      ...
      <div className="imagine-board-header-zone imagine-board-header-zone--actions">
        ...
        <div ref={overflowMenuRef} className="relative">
          ...
          {isOverflowOpen ? (
            <div
              className="imagine-board-header-menu fixed z-50 w-[13.5rem] p-1.5"
