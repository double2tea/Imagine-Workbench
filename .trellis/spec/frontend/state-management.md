...
- Team prompt template deletes must write `team_prompt_template.delete` without exposing template titles, scenes, positive/negative prompt text, parameter hints, or timestamps in audit metadata.
